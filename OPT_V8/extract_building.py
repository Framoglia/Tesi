    ...
    for sheet_name in sheet_names:
        ...
        for building_id in building_ids:
            ...
            if building_id == "ghi":
                ...
                irradiation = irradiation[:N_PERIODS_MAX]
...
def extract(folder_path, city, N_PERIODS_MAX):
    ...
    updated_buildings, irradiation = update_buildings_with_power_data(excel_path, building_data, N_PERIODS_MAX)
